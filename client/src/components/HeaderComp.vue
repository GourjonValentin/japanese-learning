        ...
        <nav>
            <div class="logo-page-links">
                <div class="navbar-logo">
                    <router-link to="/"
                        ><img
                            src="@/assets/logo-website-red-cropped.png"
                            alt="logo"
                    /></router-link>
                </div>
                <div :class="['pages-links', { active: isMenuOpen }]">
                    ...
                    <router-link
                        :to="{ path: '/auth', query: { form: 'login/signup' } }"
                        v-if="!sessionToken && isMenuOpen"
                        >Log in</router-link
                    >
                    <router-link
                        to="/settings/profile"
                    ...
                    >
                    <router-link
                        to="/settings/profile#password-settings"
                        v-if="sessionToken && isMenuOpen"
                        >Settings</router-link
                    >
                    <router-link
                        to="/settings/admin"
                        v-if="isAdmin && sessionToken && isMenuOpen"
                        >Admin settings</router-link
                    >
                    <router-link
