    ...
    <div v-if="this.$route.query.quizId === undefined" class="main">
        ...
        <div class="quizzes">
            <div class="quiz" v-for="quiz in quizzes" :key="quiz.id">
                <div
                    class="quiz-header"
                    v-if="this.userId !== '' || this.sessionToken !== ''"
                >
        ...
        <div v-if="isAttemptingQuiz" class="dialog-overlay">
            <div class="dialog">
                ...
                <div class="dialog-body">
                    ...
                    <button class="styledButton-red" @click="goToLogIn">
                        Got It
                    </button>
                </div>
            </div>
                ...
                .get("http://localhost:3000/quizzes", {
                    params: {
                        ...
                        favorites: JSON.stringify(
                            this.searchFilterFavorites ? this.favorites : null
                        ),
